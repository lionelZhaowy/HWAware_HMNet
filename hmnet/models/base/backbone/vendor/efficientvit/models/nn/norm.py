...
from hmnet.models.base.backbone.vendor.efficientvit.models.utils import build_kwargs_from_config
...
class TritonRMSNorm2d(nn.LayerNorm):
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        from hmnet.models.base.backbone.vendor.efficientvit.models.nn.triton_rms_norm import TritonRMSNorm2dFunc
